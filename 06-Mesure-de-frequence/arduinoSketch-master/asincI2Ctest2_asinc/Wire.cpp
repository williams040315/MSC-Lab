...
{
  return asincRequestResponse((uint8_t)address, (uint8_t)quantity, (uint8_t)true);
}
...
{
  return asincRequestResponse((uint8_t)address, (uint8_t)quantity, (uint8_t)sendStop);
}
