(function ($) {
  ...
  Paint.prototype = {
    ...
    _createModal: function ($content) {
      $content = $('<div class="wPaint-modal-content" style="width:300px;"></div>').append($content.children());

      var $bg = $('<div class="wPaint-modal-bg" style="width:300px;"></div>'),
          $modal = $('<div class="wPaint-modal" style="width:300px;"></div>'),
          $holder = $('<div class="wPaint-modal-holder" style="width:300px;"></div>'),
          $close = $('<div class="wPaint-modal-close" style="width:300px;">Close</div>');
